...
if __name__ == "__main__":
    ...
    try:
        M2D = avstack.modules.perception.object2dfv.MMDetObjectDetector2D(dataset='cityscapes', model='fasterrcnn')
        M3D = avstack.modules.perception.object3d.MMDetObjectDetector3D(dataset='kitti', model='pointpillars')
